...
## Trạng thái kết nối bản đồ

Dự án hiện chỉ cấu hình xác thực Supabase và các trang điều hướng theo role. Chưa có tích hợp bản đồ hay dịch vụ map nào (Google Maps, Mapbox, Leaflet, v.v.). Nếu bạn cần tính năng bản đồ, hãy cho biết yêu cầu (API provider, kiểu hiển thị, chức năng tìm kiếm/lấy vị trí, v.v.) để mình bổ sung.
